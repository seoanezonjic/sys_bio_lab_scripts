...
option_list <- list(
    ...
    make_option(c("-T", "--tag_order"), type="character", default=NULL,
        help="[OPTIONAL] Negative and Positive tag values used in TAG_COLUMNS can be specified using 'NEG_tag,POS_tag' format. Default R comparing system will be used to set NEG < POS tag values"),
